...
class ServiceProvider(AbstractBaseUser):
    ...
    aadharCard=models.ImageField(upload_to="Ser_provider/identification_docs/", null=True, blank=True,validators=[FileExtensionValidator(['jpg', 'jpeg', 'png', 'svg'])])
    electricityBill=models.ImageField(upload_to="Ser_provider/identification_docs/", null=True, blank=True,validators=[FileExtensionValidator(['jpg', 'jpeg', 'png', 'svg'])])
    policeCertificate=models.ImageField(upload_to="Ser_provider/identification_docs/", null=True, blank=True,validators=[FileExtensionValidator(['jpg', 'jpeg', 'png', 'svg'])])
